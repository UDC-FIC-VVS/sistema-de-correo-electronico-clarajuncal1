...
public class AdjuntoTest {
	...
	public void obtenerTamaño() {
		...
		assertEquals(adjunto.obtenerTamaño(), mensajePrueba.obtenerTamaño() + archivoPrueba.obtenerTamaño());
		
	}
	
	/*
	 * Obtener la visualizacion de un adjunto, para ello se crea un adjunto formado por un mensaje 
	 * y un archivo y se comprueba que la visualizacion del mensaje mas la previsualizacion de un archivo coincide
	...
	/*
	 * Obtener la ruta de un ajunto dentro de una carpeta, para ello se crea un adjunto formado por un mensaje y un archivo
	 * y una carpeta y se añade el adjunto a la carpeta y se comprueba que la ruta del padre mas la previsualizacion del adjunto
	...
	/*
	 * Se crea un adjunto y se comprueba que no ha sido leido, posteriormente se establece dicho adjunto como leido y
	...
	/*
	 * Obtener Icono, para ello se crea un adjunto y se comprueba que el icono de dicho adjunto corresponde
	...
	/*
	 * Obtener Previsualizacion, para ello se crea un adjunto y se comprueba que el contenido del mensaje de dicho 
	...
	/*
	 * ObtenerPadre , para ello creamos un correo con adjunto y una carpeta y se establece que dicha carpeta
	...
	/*
	 * Buscar adjunto, para ello se crea un correo adjunto formado por un mensaje y un archivo y una carpeta
