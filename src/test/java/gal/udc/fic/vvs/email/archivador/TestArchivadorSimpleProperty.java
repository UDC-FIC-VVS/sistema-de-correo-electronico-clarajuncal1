...
public class TestArchivadorSimpleProperty {
	 ...
	 */
	@Property
	public void AlmacenarCorreoProperty(String nombre, int espacio, String nombreTexto, String contenidoTexto) {
	 ...
	 */
	@Property
	public void ObtenerEspacioDisponibleProperty(String nombre, int espacio, String nombreTexto, String contenidoTexto) {
